...
from hardware_libraries.DFRobot_BME280 import *

'''
  # i2c_addr = 0x76: pin SDO is low
  # i2c_addr = 0x77: pin SDO is high
'''
sensor = DFRobot_BME280_I2C(i2c_addr = 0x76, bus = 1)
...
def setup():
  ...
  '''
    ...
    # Calibrating altitude to sea level (Anchorage, AK)
  ...
  '''
  if( sensor.calibrated_absolute_difference(0.0) == True ):
